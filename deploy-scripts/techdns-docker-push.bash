...
docker buildx build --build-arg SDK_VERSION=6.0-alpine --build-arg RUNTIME_VERSION=6.0-alpine --platform linux/arm64 -f "Dockerfile" -t tetricz/techdns:arm64$timevar --no-cache .
#docker buildx build --build-arg SDK_VERSION=6.0 --build-arg RUNTIME_VERSION=6.0 --platform linux/arm/v7 -f "Dockerfile" -t tetricz/techdns:armv7$timevar --no-cache .
...
docker manifest push --purge tetricz/techdns:8.12
