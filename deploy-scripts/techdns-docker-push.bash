...
docker buildx build --build-arg SDK_VERSION=6.0-alpine --build-arg RUNTIME_VERSION=6.0 --platform linux/amd64 -f "Dockerfile" -t tetricz/techdns:amd64$timevar --no-cache .
...
docker manifest create tetricz/techdns:9.0.0 tetricz/techdns:arm64$timevar tetricz/techdns:amd64$timevar --amend
docker manifest push --purge tetricz/techdns:latest
docker manifest push --purge tetricz/techdns:9.0.0
