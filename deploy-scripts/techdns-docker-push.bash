...
docker manifest create tetricz/techdns:9.1.0 tetricz/techdns:arm64$timevar tetricz/techdns:amd64$timevar --amend
docker manifest push --purge tetricz/techdns:latest
docker manifest push --purge tetricz/techdns:9.1.0
